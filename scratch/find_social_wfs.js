...
async function findSocialWfs() {
  const searchRes = await callMcpTool('search_workflows', { query: 'SOCIAL' });
  console.log('Workflows con "SOCIAL":', JSON.stringify(searchRes, null, 2));

  const searchRes2 = await callMcpTool('search_workflows', { query: 'WF' });
  console.log('Workflows con "WF":', JSON.stringify(searchRes2, null, 2));
}
