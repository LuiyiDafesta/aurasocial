...
async function testConnectionSchema() {
  const operations = [
    {
      type: "addConnection",
  ...
  const res = await callTool('update_workflow', {
    workflowId: 'QiOnKIx6QxIdzWAG',
    operations: operations,
    versionName: 'Test connection string format'
  });

  console.log('Test connection string result:', JSON.stringify(res, null, 2));
}
