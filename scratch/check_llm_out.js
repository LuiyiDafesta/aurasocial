...
async function inspectLlmOutput() {
  ...
  console.log('LLM Chain output:', JSON.stringify(execData?.data?.resultData?.runData?.['Basic LLM Chain'], null, 2));
  console.log('Save Content runData:', JSON.stringify(execData?.data?.resultData?.runData?.['Save Generated Content'], null, 2));
}
